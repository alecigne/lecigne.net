...
Common Lisp. My own configuration is available [[https://github.com/alecigne/.stumpwm.d][here]], as an ASDF
system.

We will build StumpWM from source. You can also check [[https://wiki.archlinux.org/title/Stumpwm][this page]] on
ArchWiki.

Again, here's an important quote from the StumpWM README:
...
2. Install the dependencies in SBCL:
