...
* 2026
:PROPERTIES:
:CREATED:  [2026-03-08 Sun 21:47]
:END:

** [2026-07-28 Tue]

More improvements to [[./atod/][ATOD]]!

This time it's a split between the player and archive layout for a
better experience. No noticeable effect on mobile.

Oh, and ATOD has its own [[https://github.com/alecigne/atod][GitHub repository]] -- empty for now since I
need to clean up the code, but at least it's a good place to report
[[https://github.com/alecigne/atod/issues][issues]] or simply start a [[https://github.com/alecigne/atod/discussions][discussion]].

** [2026-07-17 Fri]

I made a few improvements to [[./atod/][ATOD]] (with more to come 🙂):

- Archive search. Pretty intuitive in my opinion; you can even display
  a given month by typing e.g. "2026-03".

- Random track selection.

- Navigation to the current track.

- "Scroll-to-top" button (visible when you scroll down).

- Link to NASA's [[https://apod.nasa.gov/apod/astropix.html][Astronomy Picture of the Day]] (APOD) for a
  serendipitous aesthetic experience... even for me, since I can't
  predict which picture NASA will choose!

- Improvements to navigation controls and visual behavior.

** [2026-06-08 Mon]
:PROPERTIES:
:CREATED:  [2026-06-08 Mon 19:20]
:END:

A very quick [[file:notes/wireguard.org][note]] about useful [[https://www.wireguard.com/][WireGuard]] commands I use frequently.
...
Long time no see! Spring is already coming 🌱, [[https://lecigne.net/atod/][ATOD]] is still going
strong, and it's the perfect time of the year to hack in Lisp, with
ambient music in your ears.

After resurrecting my [[https://github.com/alecigne/.stumpwm.d][StumpWM environment]], I took the opportunity to
update the note about [[file:notes/common-lisp.org][setting up a Common Lisp environment]].
...
** [2025-12-25 Thu]
:PROPERTIES:
:CREATED:  [2025-12-25 Thu 14:47]
:END:

Added a link to [[https://lecigne.net/atod/][ATOD]] (Ambient Track of the Day) in the top menu. I
will try to add one ambient track per day in 2026. Stay tuned!

** [2025-12-21 Sun]
:PROPERTIES:
:CREATED:  [2025-12-21 Sun 12:12]
:END:

Added a few projects to the [[file:projects/projects.org][projects page]], and started a list of
projects I rely on.

** [2025-12-03 Wed]
:PROPERTIES:
:CREATED:  [2025-12-03 Wed 21:21]
:END:

I created a [[https://lecigne.net/feed/][feed]] section, a visual feed/photo journal.

** [2025-11-15 Sat]
:PROPERTIES:
:CREATED:  [2025-11-15 Sat 18:08]
:END:

A new [[file:notes/synology-domains.org][note]] about setting up local domains on a LAN using a Synology
NAS.
